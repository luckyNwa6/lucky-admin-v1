...
import { getScientificCounting } from '@/utils'
...
export default {
  ...
  methods: {
    initLuckyChart() {
      ...
      let dataValue = [1.11e21, 1.11e21, 111112222244.1541, 1.11e21, 0, 0, 0, 0, 0, 0, 0, 0] //y轴数据1
      let dataValue1 = [1.0, 455555555555553.0, 2.0, 1.0, 3, 1, 2, 3.2, 4.5, 5.0, 4.3, 3] //y轴数据2
      let dataValue2 = [999999993, 6, 7, 15, 8, 5, 2, 5, 4, 2, 10, 3] //y轴数据3
